...
The distribution of this data seems to be slightly skewed to the left, however the mean is pretty close to the peak on this chart. If it were a normal distribution, the data in between minus one standard deviation and plus one standard deviation would be 68% of the data. Since it is not a normal distribution, we look at data ranging from 8 to 17. There are 24/31 values in this range, which is about 77.4%. So to me, this data is about 90% normal.
