...
gdp_data |> 
  ...
  labs(title = "Correlation between GDP and DJIA
      ")
...
There is a strong positive correlation between DJIA and GDP that suggests when DJIA increases, GDP also increases. The scatterplot is relatively centered around the line, with a few deviations around teh DJIA=30,000 mark
